...
function App() {
  ...
  // escucha los cambios que sucedan en filtro
  useEffect(() => {
    if(filtro) {
  ...
  const guardarGasto = gasto => {
    if(gasto.id) {
      // Actualizar
      const gastoActaulizados = gastos.map(gastoState => gastoState.id === gasto.id ? gasto : gastoState)
      setGastos(gastoActaulizados);
      setGastoEditar({})
